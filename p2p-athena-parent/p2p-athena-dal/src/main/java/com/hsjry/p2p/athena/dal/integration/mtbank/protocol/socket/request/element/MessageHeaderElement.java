...
import com.hsjry.p2p.athena.dal.integration.mtbank.protocol.socket.request.constants.EnumSystemType;
...
//        if (!StringUtils.isBlank(response.getLastFragment())) {
//            list.add(XmlLeaf.generate(EnumComponentType.LastFragment, response.getLastFragment()));
//        }
        return list;
    }
}
